...
async function performGlobalSearch() {
    ...
    try {
        ...
        if (data.pages && data.pages.length) {
            ...
            html += data.pages.map(p => `<button onclick="closeGlobalSearch();openBook(${p.bookId},undefined,${JSON.stringify(q)})" class="w-full text-right p-3 bg-white rounded-xl border border-gray-100 hover:bg-emerald-50 transition shadow-sm mb-2 block">
